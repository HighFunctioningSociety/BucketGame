...
public class AbilityManager : MonoBehaviour
{
    ...
    private void GetAttack()
    {
        ...
        if (Inputs.attack && (Inputs.Vertical < 0) && !player.controller.grounded)
        {
    ...
    public void Vault()
    {
        if (Inputs.attackHeld && stingerAttack.enNum != 0)
        {
            ...
            player.rb.AddForce(new Vector2(70 * player.controller.dir, 150), ForceMode2D.Impulse);
        }
    }
