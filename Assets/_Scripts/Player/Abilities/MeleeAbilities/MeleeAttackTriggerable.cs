...
public abstract class MeleeAttackTriggerable : PlayerAttackTriggerable
{
    ...
    protected void DrawHitEffect(Collider2D collider)
    {
        ...
        hitSpawn.transform.localScale = new Vector3(hitSpawn.transform.localScale.x * player.controller.dir, hitSpawn.transform.localScale.y, hitSpawn.transform.localScale.z);
    }
}
