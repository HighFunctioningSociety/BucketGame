...
[CreateAssetMenu(menuName = "Abilities/BasicLingering")]
public class LingeringMeleeAbility : MeleeAbilities
{
    private LingeringTriggerable attack;
    ...
    {
        attack = obj.GetComponent<LingeringTriggerable>();
