...
public class Rumbler : MonoBehaviour
{
    ...
    // Public Methods
    public static void RumbleConstant(float low, float high, float durration)
    {
        _rumbler._RumbleConstant(low, high, durration);
    }

    public static void RumblePulse(float low, float high, float burstTime, float durration)
    {
        _rumbler._RumblePulse(low, high, burstTime, durration);
    }

    public static void RumbleLinear(float lowStart, float lowEnd, float highStart, float highEnd, float durration)
    {
        _rumbler._RumbleLinear(lowStart, lowEnd, highStart, highEnd, durration);
    }

    private void _RumbleConstant(float low, float high, float durration)
    {
        if (rumbleOn)
        {
    ...
    private void _RumblePulse(float low, float high, float burstTime, float durration)
    {
        if (rumbleOn)
        {
    ...
    private void _RumbleLinear(float lowStart, float lowEnd, float highStart, float highEnd, float durration)
    {
        if (rumbleOn)
        {
